...
module.exports = {
    ...
    callback: function(event, context, cb){
        ...
        return DBService.query(DBService.PREAUTH_TABLE, condition)
                ...
                .then(function(oauth_data){
                    ...
                    return OAuthService.tripitProfile(oauth_data)
                        .then(function(profile){
                            console.log("FINISHED TRIPIT PROFILE")
                            ...
                            return DBService.upsert(DBService.USERS_TABLE, key_condition, attributes)
                                ...
                                .then(function(){
                                    ...
                                    console.log("UPSERT FINISHED SUCCESSFULLY")
                                    console.log(key_condition)
            ...
            // })
            .then(function(data){
                console.log("THIS IS THE SECURITY SERVICE TOKEN")
                console.log(data)
                return cb(null, data)
            })
            .fail(function(err){
                return cb(JSON.stringify(err), null)
            })
    }
}